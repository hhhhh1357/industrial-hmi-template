...
#include "SubWorker3012.h"

#include <Headers/BLL/BLocalService.h>

extern BLocalService * localService;

SubWorker3012::SubWorker3012(QString ip, QString pw, QString mn, SqliteTools *sqlTools, QObject *parent):SubWorkerBase(ip, pw, mn, sqlTools, parent)
{

}
SubWorker3012::~SubWorker3012()
{
    //qDebug() << __FILE__ << ", " << __func__ << " was called !" << endl;
}
void SubWorker3012::doWork(Task task)
{
...
QString SubWorker3012::buildCloudCmd(Task &task, bool &shouldDone)
{
    return "";
