...
#include "SubWorker3014.h"

#include <Headers/BLL/BLocalService.h>

extern BLocalService * localService;

SubWorker3014::SubWorker3014(QString ip, QString pw, QString mn,SqliteTools *sqlTools, QObject *parent):SubWorkerBase(ip, pw,  mn,sqlTools, parent)
{

}
SubWorker3014::~SubWorker3014()
{
    //qDebug()<<__FILE__ << ", " << __func__<<" was called !"<<endl;
}

void SubWorker3014::doWork(Task task)
{
...
QString SubWorker3014::buildCloudCmd(Task &task, bool &shouldDone)
{
    return "";
